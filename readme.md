...
- Open the `/fellowships.js` file. This is where you will work. Define and invoke the functions outlined as comments.
...
As mentioned above, fork and clone this repo to get moving.
